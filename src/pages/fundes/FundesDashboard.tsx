...
const FundesDashboard: React.FC<FundesDashboardProps> = () => {
  ...
  const chartConfig = {
    company: { label: "Company", theme: { light: "#0ea5e9", dark: "#0284c7" } },
    startup: { label: "Startup", theme: { light: "#10b981", dark: "#059669" } },
    investor: { label: "Investor", theme: { light: "#8b5cf6", dark: "#7c3aed" } }
  };
